...
public enum GeoHashLevel {
	...
	ONE(2, 3, 1, 5009.4 * 1000, 4992.6 * 1000), TWO(5, 5, 2, 1252.3 * 1000, 624.1 * 1000),
	THREE(7, 8, 3, 156.5 * 1000, 156.5 * 1000), FOUR(10, 10, 4, 39.1 * 1000, 19.5 * 1000),
	FIVE(12, 13, 5, 4.9 * 1000, 4.9 * 1000), SIX(15, 15, 6, 1.2 * 1000, 0.61 * 1000), SEVEN(17, 18, 7, 152.9, 152.4),
