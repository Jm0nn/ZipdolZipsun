...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		builder.append("			</li> \n");
		builder.append("			<li class=\"page-item\" data-pg=\"" + (currentPage == 1 ? 1 : (currentPage - 1)) + "\"> \n");
		...
		builder.append("			<li class=\"page-item\" data-pg=\"" + (currentPage == endPage ? endPage : (currentPage + 1)) + "\"> \n");
